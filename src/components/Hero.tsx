    ...
    <header className="paper-texture relative overflow-hidden">
      ...
      >
        <svg width="320" height="320" viewBox="0 0 320 320" fill="none">
          <circle cx="160" cy="160" r="150" stroke="#8B9E83" strokeWidth="1.5" />
          <circle cx="160" cy="160" r="115" stroke="#8B9E83" strokeWidth="1.2" />
      ...
      >
        <svg width="300" height="300" viewBox="0 0 300 300" fill="none">
          <circle cx="150" cy="150" r="140" stroke="#C4A882" strokeWidth="1.5" />
          <circle cx="150" cy="150" r="105" stroke="#C4A882" strokeWidth="1.2" />
      ...
      <div className="relative mx-auto max-w-4xl px-4 py-20 text-center sm:py-28">
        ...
        <p className="mx-auto mt-6 max-w-xl font-sans text-base leading-relaxed text-espresso/80 sm:text-lg">
          Velas artesanales de soja, moldeadas y piezas en cemento — hechas a
          mano.
        </p>
